<div class="dishes">
	...
	<div class="searchContainer">
		<form action="/admin/boissons/search" class="searchBar" method="POST">
	...
	<div class="containerButtonMenu drinks">
		<?php for ($i = $firstDrinkType; $i < $typesOfDrinks; $i++) : ?>
			<?php $drinkTypeName = Drink::drinkTypeName($i);
				if($drinkTypeName != ''){
			?>
			<a href="#<?= $drinkTypeName ?>">
				<button>
					<?= ucfirst($drinkTypeName) ?>
				</button>
			</a>
			<?php } ?>
		<?php endfor; ?>
	...
	<div class="returnToTop">
		<a href="#top">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
				<!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
				<path fill="#f3f3f3" d="M214.6 41.4c-12.5-12.5-32.8-12.5-45.3 0l-160 160c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 141.2V448c0 17.7 14.3 32 32 32s32-14.3 32-32V141.2L329.4 246.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-160-160z" />
			</svg>
		</a>
	</div>
...
<div class="modale">
	<div class="modaleContent">
		...
		<div class="modaleBtn">
			...
			<a class="deleteDrinkLink" href="">Supprimer</a>
		</div>
	</div>
</div>
...
<script src="../../public/assets/js/confirmDrinkDelete.js"></script>
